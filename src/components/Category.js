...
export default function Category() {
  ...
  return (
    <section className={styles.section}>
      ...
      <div
        className={`${styles.categoryRow} ${styles.slideRightOnce}`}
        ref={aboutRef}
      >
      ...
      <div className={styles.container}>
        <div className={styles.aboutSection}>
          <div
            className={`${styles.aboutLeft} ${styles.animLeft}`}
            ref={leftRef}
          >
            ...
            <p className={styles.hh3}>
              Make your home feel as comfortable and welcoming as possible with
          ...
          <div className={styles.aboutRight}>
            ...
            <div
              className={`${styles.smallRound} ${styles.animRight}`}
              ref={smallRef}
            >
