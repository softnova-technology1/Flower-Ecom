                            ...
                            <div className={`${styles.fourReasons} d-flex`}>
                                <div className="" data-aos="fade-right" data-aos-duration="700">
                                    <div className={styles.reasons1}>
                                        <div className={styles.svg}>
                                            <svg aria-hidden="true" className="e-font-icon-svg e-fas-box" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="" data-aos="fade-left" data-aos-duration="700">
                                    ...
                                    <div className={styles.reasons4}>
                                        <div className={styles.svg}>
                                            <svg aria-hidden="true" className="e-font-icon-svg e-fas-headset" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
