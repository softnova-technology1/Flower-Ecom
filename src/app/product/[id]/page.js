        ...
        const fetchProduct = async () => {
            try {
                ...
                if (data.success) {
                    ...
                    const relatedData = await productsAPI.getByCategory(data.product.category);
                    setRelatedProducts(
            ...
            <PageWrapper>
                ...
                <div className={styles.page}>
                    ...
                    <div className={styles.rightBox}>
                        ...
                        <p className={styles.description}>
                            {product.description || "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus luctus nec ullamcorper mattis, pulvinar dapibus leo."}
                        </p>
                ...
                <div className={styles.reviewBox}>
                    <div className={styles.reviewTabContainer}>
                        <div className={styles.reviewTab}>Reviews ({product.numReviews || 0})</div>
                    </div>
                        ...
                        {relatedProducts.map((item) => (
                            <div className={styles.scard} key={item._id}>
                                ...
                                <div className={styles.btnContainer}>
                                    <button
                                        className={`${styles.cartBtn} ${buttonState[item._id] === "added" ? styles.success : ""
                                            }`}
